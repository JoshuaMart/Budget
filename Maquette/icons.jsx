...
const Icon = ({ name, size = 16 }) => {
  ...
  switch (name) {
    ...
    case 'chart': return <svg {...props}><path d="M3 3v18h18M7 14l4-4 4 4 5-7"/></svg>;
    ...
    case 'wallet': return <svg {...props}><path d="M19 7H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM3 9V6a2 2 0 0 1 2-2h11M17 13h.01"/></svg>;
    case 'piggy': return <svg {...props}><path d="M3 12a9 9 0 0 1 9-9 9 9 0 0 1 9 9v3l2 2v2h-3l-1 2h-4l-1-2h-4l-1 2H6l-1-2H3z"/><circle cx="16" cy="11" r="0.8"/></svg>;
    default: return null;
  }
};
